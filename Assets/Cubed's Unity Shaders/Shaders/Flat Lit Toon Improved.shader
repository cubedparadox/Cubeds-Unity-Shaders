    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float node_4029 = dot(Function_node_36932( i.normalDir ),node_1053);
                float node_1676 = dot(i.normalDir,lightDirection);
                float node_1382 = dot(_LightColor0.rgb,float3(0,0.3823529,0.01845836));
                float node_5768 = (node_1676*node_1382);
                float node_638 = dot(node_1053,aaa( float3(0,-1,0) ));
                float node_5393 = (dot(lightDirection,float3(0,-1,0))*node_1382);
                float node_3207 = (node_638+node_5393);
                float node_6478 = (node_1382*dot(lightDirection,float3(0,1,0)));
                float node_9834 = 0.0;
                float node_1498 = (node_9834 + ( ((node_4029+node_5768) - node_3207) * (1.0 - node_9834) ) / ((dot(node_1053,bbb( float3(0,1,0) ))+node_6478) - node_3207));
                float node_3365 = 2.0;
                float node_954 = saturate((node_2323+saturate((floor(attenuation * node_5023) / (node_5023 - 1)*floor(node_1498 * node_3365) / (node_3365 - 1)))));
                float3 node_7956 = lerp((node_5427*saturate((Function_node_369( float3(0,-1,0) )+node_4082))),(node_5427*saturate((Function_node_3693( float3(0,1,0) )+node_4082+_LightColor0.rgb))),node_954);
